  ...
  return (
    <div className="w-screen h-screen flex flex-col  items-center justify-center ">
      <div className="flex items-center justify-center  ">
        ...
        <div
          className={`text-3xl  text-black transition-opacity duration-1500 ease-in-out font-sans text-center ${showText ? "opacity-100 translate-x-10" : "opacity-0 translate-x-10"
            }`}
        >
