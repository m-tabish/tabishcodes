import { ArrowTopRightIcon, GitHubLogoIcon, InstagramLogoIcon, Link1Icon, LinkedInLogoIcon, TwitterLogoIcon } from "@radix-ui/react-icons";
...
export default function Home() {
    ...
    return (
        <div className="w-screen h-screen flex bg-[#f2f0ef]">
            ...
            <section className="border-gray-300 border-r-1 flex flex-col w-2/5 gap-10">
                ...
                <section className="h-2/3 text-3xl text-center flex flex-col items-center p-4">
                    ...
                    <p className="h-fit text-clip overflow-clip text-sm px-2">A Computer Science Engineering student passionate about Web Development and Machine Learning.</p>
            ...
            <section className="border-l-1 border-gray-300 w-2/5 flex flex-col mt-6 pt-6">
                <div className="h-full text-center flex flex-col">
                    ...
                    <p className="mt-2 text-start pl-4 font-semibold">
                        <span className="border-1 rounded-sm bg-green-100 px-2 text-green-700">15/3/25</span> Offline Hackathon
                        <br />
                        <span className="font-normal ">

                            Would request to <a className="underline font-bold text-blue-700" href="https://docs.google.com/forms/d/e/1FAIpQLSeDBMLJ2Kj6-g7VVYo0uwRn-Yw7PdOPqj1wm5U_uqYYm4o89g/viewform?usp=header">fill this short survey</a> form for our project. </span>
                        <a href="https://x.com/damnthesebugs/status/1900972680217850236" className="flex gap-2 items-center font-bold hover:underline " >Know More<ArrowTopRightIcon /> </a>
                    </p>
                    <br />
